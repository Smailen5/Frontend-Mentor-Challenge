...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-center flex-col gap-4 mt-8 absolute top-0 left-0 right-0 md:flex-row md:justify-between md:mx-8 xl:mx-24 xl:mr-28">
