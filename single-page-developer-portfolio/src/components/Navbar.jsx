...
const Navbar = () => {
  ...
  return (
    <nav className="absolute flex w-full flex-col items-center pt-6 lg:pt-10">
      <div className="absolute flex w-full flex-col items-center gap-6 px-10 md:flex-row md:justify-between lg:px-56">
