...
//   return (
//     <picture className="h-auto w-full md:absolute md:right-[-20px] md:top-[-180px]">
//       {/* IMMAGINI DESKTOP */}
...
//         src={imgHeroWebp}
//         alt="image hero"
//         className="md:transform-origin-top-right h-auto w-full scale-125 object-cover md:absolute md:ml-20 md:min-h-[150%] md:min-w-[150%] md:translate-y-[-10%] md:transform"
//       />

//       {/* <img
//         src={imgHeroWebp}
//         alt="image hero"
//         className="h-auto w-full scale-125 object-cover md:absolute md:ml-20 md:min-h-[150%] md:min-w-[150%]"
//       /> */}
//     </picture>
//   );
// };
